# Task 1. Напишите пр-му вычисления арифмитичексого заданного строкой.
# Используйтк операции +,-,/,*, приоретет операций стандартный.
# 1 Находим знаки с наивысшим приоритетом / и *.Последование выполнения знаков с приоритетом.
# 2 Калькулируем цифры с двух сторон знака.
# 3 Находим знаки с наименьшим приоритетом и каклькулируем их
# 4 Выводим результат

# operation = input('Введите то, что будем считать => ').split()
string = '10+200*3/2'
lst = []
buf = ''
